...
# -----------------------------------------------------------------------
JOBS=(
    "basketball-wj   TEST_DB=basketball     CARDINALITY_TYPES=wj DEVICE=0 AUGMENT=False"
    "consumer-wj     TEST_DB=consumer       CARDINALITY_TYPES=wj DEVICE=1 AUGMENT=False"
    "carc-wj         TEST_DB=carcinogenesis CARDINALITY_TYPES=wj DEVICE=1 AUGMENT=False"
