...
python analyze_refinement_similarity.py --test_db $TEST_DB --card_type $CARD_TYPE --model_config ddestfonudf_liboh_gradnorm_mldupl_loopend_loopedge --model_dir $MODEL_DIR --model_name $MODEL_NAME --augment_pooling $POOLING --augment_coarse_layers $COARSE_LAYERS --queries_csv results/worst_queries/${TEST_DB}_${MODEL_NAME}_worst50_best50.csv --device cuda:0
